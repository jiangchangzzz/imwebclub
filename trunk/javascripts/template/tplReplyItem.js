(function(root, factory) {
    ...
    return function(it, opt) {
        ...
        if (it.isLogin) {
            _$out_.push('<div class="foot-wrap"><div class="reply-btn-area"><span class="item">', reply.friendly_create_at, '</span>');
              _$out_.push('<span class="item"><span class="sub-count">', reply.subReplies.length, '</span>');
            _$out_.push('<a href="javascript:;" class="open-sub-reply">回复</a></span>');
            ...
            _$out_.push('<a href="javascript:void(0);" data-name="', reply.author.loginname, '"> <img class="avatar js-identicon" src="', reply.author.avatar, '" title="', reply.author.loginname, '" /> </a>');
            _$out_.push(reply.author.loginname, '</a></div>');
